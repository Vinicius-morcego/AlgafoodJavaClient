...
public class ClientApiException extends RuntimeException{
	...
	public ClientApiException(String message, RestClientResponseException cause) {
		...
		deserialiseProblem(cause);
	}
	
	

	private void deserialiseProblem(RestClientResponseException cause) {
		...
		try {
			...
			log.warn("Não foi possivel deserializar a resposta em um problema", e);
		}
